...
class Loaders {
  ...
  public static function ipv4($value) {
    ...
    throw new Exception('Se requiere una valida dirección IPv4, por ejemplo \'192.168.0.1\'.');
  }
  ...
  public static function ipv6($value) {
    ...
    throw new Exception('Se requiere una valida dirección IPv6, por ejemplo \'2001:db8::\'.');
  }
